...
<!--Header-->
    <header class="row justify-content-between shadow-lg">
      ...
      <div class="col-6">
        <p class="row justify-content-around align-items-center title">Amnesia</p>
      </div>
...
<div class="position-fixed top-0 end-0">
  <div class="my_navbar collapse navbar flex-column rounded-bottom" id="navbarToggleExternalContent">
    <a class="navbar-brand my_nav-text-color" href="#">Amnesia</a>
    ...
    <main class="row m-3">
      <div class="col-12">
        ...
        <article class="article4 row">
          <p class="row h-100 justify-content-center align-items-center">ARTICLE 4</p>
        </article>
      </div>
    </main>
